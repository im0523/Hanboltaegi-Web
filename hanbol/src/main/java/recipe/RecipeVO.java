...
public class RecipeVO {
	private int readcnt, no, root, step, indent;
	private String recipe_id, user_pic, nickname, title, subtitle, portion, time, cat1, cat2, cat3, cat4, degree, writedate, userid,
